    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 14: Secuencias\n\nLos contadores son muy utiles a la hora de formar secuencias que se repiten una y otra vez.\nNormalmente son tablas o memorias.\n\nEn el siguente ejemplo vamos a generar una secuencia con los LEDs.\nEs por eso que para darles salida. Generamos una tabla con todas las salidas posibles.\nDependiendo cual sea el valor del contador se iran iluminando los LEDs.\n",
            "readonly": false
          },
          "position": {
            "x": 88,

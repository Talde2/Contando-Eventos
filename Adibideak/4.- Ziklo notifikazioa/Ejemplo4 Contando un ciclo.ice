    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 4: Ciclo contador\n\nComo hemos comentado antes, cuando el contador llega a su maximo, automaticamente empieza a contar desde 0 otra vez.\nPero a su vez, este genera un pulso o tic de salida, notificando que ha completado un ciclo. \n\nEn este ejemplo, utilizaremos ese tic de salida para guardarlo en una memoria (biestable), a modo de notificacion. \n\nComo no disponemos de otro boton, haremos que no se pueda resetear esta notificacion. Asi que en el ejemplo, solo veremos cuando el\ncontador alcanze el primer ciclo. ",
            "readonly": false
          },
          "position": {
            "x": -168,

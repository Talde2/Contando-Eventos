    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 9: Contando grupos de eventos\n\n\nEn este ejemplo, encadenamos dos contadores para hacer la cuenta de un grupo de eventos.\n\nEntendemos un grupo de eventos, a varias acciones que forman un evento.\n\nEn nuestro caso, haremos que nuestros contadores en cadena, cuenten el numero de veces que hacemos doble clic\npor ejemplo.\n",
            "readonly": false
          },
          "position": {
            "x": -168,

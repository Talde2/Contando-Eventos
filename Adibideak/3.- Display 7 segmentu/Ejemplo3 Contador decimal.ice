    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 3: Contandor decimal\n\nEn este ejemplo, reflejaremos nuestro contador mediante un display de 7 segmentos.\nEste esta compuesto por 8 LEDs independientes. Es por eso, que conectaremos 7 salidas, una para cada LED.\nSegun, que segmentos se enciendan, representaran un digito u otro. \n\n\nEl funcionamiento de este bloque es sencillo. Con el display entamos trabajando tambien con nunmeros binarios,\nen este caso con 7 bits. Actua como un decodificador, es decir, a su entrada entra un digito (el numero de pulso que\nle llega desde nuestro contador) y a saca na su salidas el digito representado en binario. Donde unos segmentos se \nencenderan y otros permaneceran apagados. Dando asi forma a un digito decimal.",
            "readonly": false
          },
          "position": {
            "x": -168,

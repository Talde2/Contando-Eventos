    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 7: Dos contadores de 2-bits en cadena\n\nEn este ejemplo vamos a encadenar dos contadores. Como hemos explicado antes, nuestro contador al \ncompletar un ciclo. es decir cuando llega a la cuenta maxima, genera un tic de salida para las \nsiguentes etapas. \n\nEn en caso, vamos a utilizar ese mismo tic, para dar paso a otro contador. \n\nEn uno veremos los tics de nuestro pulsador que se iran conatando en binario. En el otro,\nveremos en el display decimal, en numero de ciclos (cuenta maxima totales) que se van completando. ",
            "readonly": false
          },
          "position": {
            "x": -200,

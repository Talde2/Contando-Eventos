  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "80d551a3-1276-4393-87cb-b14b29dbbecf",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "a93d008a-260a-4fca-ba75-bb8e83eafc0d",
          "type": "basic.constant",
          "data": {
            "name": "Modulo ",
            "value": "3",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Este es el boton de reset",
            "readonly": false
          },
          "position": {
            "x": 160,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 5: Modulo contador\n\nCuando hablamos del modulo del contador, nos referimos al numero maximo que nuestro contador podra contar. \n\nEs decir, hasta ahora hemos utilizado este contador de 2 bits. Donde se puede contar desde 0 hasta 3. Un total de 4\ndigitos, un contador de modulo 4.\n\nAun y todo podemos decirle a nuestro contador que solo cuente de 0 a 2, cambiando asi, su modulo a un modulo de 3.\nEn resumidas palabras, que solo pueda contar hasta el maximo de 2. ",
            "readonly": false
          },
          "position": {
            "x": -168,
        ...
        {
          "id": "64d55920-dacf-429f-ab3f-9cd8e36df9ba",
          "type": "basic.info",
          "data": {
            "info": "Este es el boton que pulsaremos\npara enviar los pulsos.",
            "readonly": false
          },
          "position": {
            "x": 48,
        ...
        {
          "id": "72db924b-76bd-4bf0-afc1-df294189254c",
        ...
        {
          "id": "f9808ca7-2893-4ea5-b3c6-22a550a3f7ab",
        ...
        {
          "id": "d70495f0-82db-40ff-971b-a92f4d02160d",
          "type": "basic.info",
          "data": {
            "info": "Este bloque es un biestable. Una memoria que\nguarda nuestro tic de salida de contador.\n\nCuando cumpla un ciclo, este generara un pulso\ny nosotro activaremos un led con el, a modo de\nnotificacion.\n\nDespues para borrar la memoria se puede hacer\nun reset. ",
            "readonly": false
          },
          "position": {
            "x": 664,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "72db924b-76bd-4bf0-afc1-df294189254c",
        ...
        {
          "source": {
            "block": "f9808ca7-2893-4ea5-b3c6-22a550a3f7ab",
        ...
        },
        {
          ...
          "target": {
            "block": "80d551a3-1276-4393-87cb-b14b29dbbecf",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "a93d008a-260a-4fca-ba75-bb8e83eafc0d",
            "port": "constant-out"
          },
          "target": {
            "block": "3dd48ba8-3f8f-41f1-85fa-414bda87bab3",

    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 8: Contador hexadecimal de 4 bits\n\nEn este ejemplo, vamos a encadenar dos contadores de 2 bits para crear uno de 4 bits y asi poder representar\nnuestra cuenta en el display hexadecimal. \n\nAñadimos el bloque de multiplexor para unir las dos salidas de los contadores con el digito de tics. \n\nComo vemos, el hecho de que esten encadenados, hace que el tic de notificacion de cilco completo sea la entrada\ndel segundo contador. \n",
            "readonly": false
          },
          "position": {
            "x": -56,

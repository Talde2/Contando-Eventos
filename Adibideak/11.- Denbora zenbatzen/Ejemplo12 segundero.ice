    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 12: Contando el tiempo, Segundero  \n\nEn este ejemplo, contaremos el tiempo. Para eso utilizamos un corazon de tics. \nEste mediante un reloj va generando tics periodicamente.\n\nNuesntro contador, recibira esos tic y los ira contando, simnulando un segundero. ",
            "readonly": false
          },
          "position": {
            "x": -72,

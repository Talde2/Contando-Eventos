  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "9a7d06cc-9611-47d9-9785-79c6946e4866",
          "type": "basic.input",
          "data": {
            "name": "PULSADOR",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 10: Escáner de supermercado\n\nEn este ejemplo, le añadimos un buzzer a nuestro contador.\n\nAgragamos el modulo de temporizador, para que una vez pulsemos el boton, este emita un pitido durante un breve tiemnpo y acto seguido,\nregistre el el contador el tic. ",
            "readonly": false
          },
          "position": {
            "x": 72,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "9a7d06cc-9611-47d9-9785-79c6946e4866",
            "port": "out"
          },
          "target": {
            "block": "3821f822-4216-4389-854b-4fbe22cf13a9",
